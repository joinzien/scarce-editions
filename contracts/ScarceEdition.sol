...
contract ScarceEdition is ERC721 {
  ...
  /**
    ...
    * @param uri uri of the work
    */
  function batchCreatecreate(uint256 batchSize, address[maxBatch] memory to, uint256[maxBatch] memory tokenId, string[maxBatch] memory uri) public ownerOrOperatorOnly returns (bool) {
